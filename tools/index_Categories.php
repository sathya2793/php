			...
			$(document).ready(function() {
			   var dataTable =  $('#employee-grid').DataTable( {
			   	dom: 'T<"clear">lfrtip',
					...
					"serverSide": true,
					"ajax":{
						url :"fetch_Categories.php", // json datasource
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <h4 class="modal-title" id="myModalLabel">Create Categories</h4>
		      </div>

		      <div class="modal-body">
		      		<form data-toggle="validator" action="http://localhost:8888/tools/create_Categories.php" method="POST">
...
if(isset($_POST['btnEdit'])){
    ...
    $sqlupdate="UPDATE public.categories SET topic='$new_topic',
...
if(isset($_GET['delete'])){
    $id=$_GET['delete'];
    $sqldelete="DELETE FROM public.categories WHERE id='$id'";
